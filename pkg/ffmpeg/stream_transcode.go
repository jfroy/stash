...
func CodecInit(codec VideoCodec) (args Args) {
	...
	case VideoCodecN264:
		args = append(args,
			// https://docs.nvidia.com/video-technologies/video-codec-sdk/11.1/ffmpeg-with-nvidia-gpu/index.html#command-line-for-latency-tolerant-high-quality-transcoding
			//"-preset", "p4",
			//"-tune", "hq",
			//"-b:v", "20M",
			//"-bufsize", "20M",
